        ...
        child: BackdropFilter(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                _buildNavItem(0, Icons.grid_view, 'CHAMBERS', colors, theme),
                _buildNavItem(1, Icons.factory, 'FACTORY', colors, theme),
                _buildNavItem(2, Icons.auto_awesome, 'SUMMON', colors, theme),
                _buildNavItem(3, Icons.memory, 'TECH', colors, theme),
                _buildNavItem(
                  4,
                  Icons.military_tech,
                  'PRESTIGE',
