...
class HoloWorkerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String buttonLabel = actionLabel ?? _getActionLabel(status);
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                // CENTER: Info Column
                Expanded(child: _buildInfoColumn(statusColor)),

                const SizedBox(width: 8),

                // RIGHT: Action Button & Efficiency Badge
                _buildActionColumn(statusColor, buttonLabel),
              ],
            ),
          ),
        ),
  ...
  Widget _buildInfoColumn(Color statusColor) {
    return Column(
      ...
      children: [
        ...
        // Efficiency bar
        _buildEfficiencyBar(statusColor),
      ],
    );
  }

  Widget _buildEfficiencyBar(Color statusColor) {
    return Row(
      children: [
        Expanded(
          child: Container(
  ...
  Widget _buildActionColumn(Color statusColor, String buttonLabel) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
